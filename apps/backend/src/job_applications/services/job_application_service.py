...
class JobApplicationService:
    ...
    def create_job_application(
        ...
        """
        # Create the new user
        return self.user_repository.create(application_data)

    def get_job_application(self, application_id: str) -> Optional[JobApplication]:
        """
        ...
        """
        return self.job_application_repository.get_by_id(application_id)
    ...
    def update_company_profile_discovery_results(
        ...
        try:
            job_application = self.get_job_application(application_id)
