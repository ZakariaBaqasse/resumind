...
import { ResumeStrategyBrief } from "@/types/application.types"
import { Badge } from "@/components/ui/badge"

type ResultsHeaderProps = {
  strategyBrief: ResumeStrategyBrief | null | undefined
  title: string
}

const ResultsHeader = memo(({ strategyBrief, title }: ResultsHeaderProps) => {
  return (
