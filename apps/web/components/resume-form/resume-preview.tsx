...
export default function ResumePreview({ detailedResume }: ResumePreviewProps) {
  return (
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
          <div>
            ...
            <span className="ml-2 text-gray-900">{detailedResume.name}</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span className="ml-2 text-gray-900">{detailedResume.email}</span>
          </div>
          <div>
